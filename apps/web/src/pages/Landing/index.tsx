...
const Glow = styled.div`
  ...
  top: 68px;
  bottom: 0;
  background: radial-gradient(72.04% 72.04% at 50% 3.99%, #4ebfbf 0%, rgba(166, 151, 255, 0) 100%);
  filter: blur(72px);
  border-radius: 24px;
  max-width: 480px;
  width: 100%;
...
const TitleText = styled.h1<{ isDarkMode: boolean }>`
  ...
  ${({ isDarkMode }) =>
    isDarkMode
      ? css`
          background: linear-gradient(20deg, rgba(255, 244, 207, 1) 10%, rgba(137, 191, 191, 1) 100%);
        `
      : css`
          background: linear-gradient(10deg, rgba(92, 191, 191, 1) 0%, rgba(137, 191, 191, 1) 100%);
        `};
...
const ButtonCTA = styled(LandingButton)`
  background: linear-gradient(93.06deg, #2fbfbf 2.66%, #89bfbf 98.99%);
  border: none;
  color: ${({ theme }) => theme.white};
  transition: ${({ theme }) => `all ${theme.transition.duration.medium} ${theme.transition.timing.ease}`};

  &:hover {
    box-shadow: 0px 0px 16px 0px #2fbfbf;
  }
`
