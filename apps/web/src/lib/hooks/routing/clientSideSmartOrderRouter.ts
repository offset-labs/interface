import { BigintIsh, ChainId, CurrencyAmount, Token, TradeType } from '@offsetcarbon/sdk-core'
// This file is lazy-loaded, so the import of smart-order-router is intentional.
// eslint-disable-next-line @typescript-eslint/no-restricted-imports
import { AlphaRouter, AlphaRouterConfig } from '@offsetcarbon/smart-order-router'
